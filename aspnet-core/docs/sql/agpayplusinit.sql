...
VALUES ('mgrSiteUrl', '运营平台网址(不包含结尾/)', '运营平台网址(不包含结尾/)', 'applicationConfig', '系统应用配置', 'http://127.0.0.1:9217', 'text', 'MGR', '0', 0, NOW());
INSERT INTO `t_sys_config` (`config_key`, `config_name`, `config_desc`, `group_key`, `group_name`, `config_val`, `type`, `sys_type`, `belong_info_id`, `sort_num`, `updated_at`) 
VALUES ('agentSiteUrl', '代理商平台网址(不包含结尾/)', '代理商平台网址(不包含结尾/)', 'applicationConfig', '系统应用配置', 'https://127.0.0.1:9816', 'text', 'MGR', '0', 0, NOW());
INSERT INTO `t_sys_config` (`config_key`, `config_name`, `config_desc`, `group_key`, `group_name`, `config_val`, `type`, `sys_type`, `belong_info_id`, `sort_num`, `updated_at`) 
VALUES ('mchSiteUrl', '商户平台网址(不包含结尾/)', '商户平台网址(不包含结尾/)', 'applicationConfig', '系统应用配置', 'http://127.0.0.1:9218', 'text', 'MGR', '0', 0, NOW());
INSERT INTO `t_sys_config` (`config_key`, `config_name`, `config_desc`, `group_key`, `group_name`, `config_val`, `type`, `sys_type`, `belong_info_id`, `sort_num`, `updated_at`) 
VALUES ('paySiteUrl', '支付网关地址(不包含结尾/)', '支付网关地址(不包含结尾/)', 'applicationConfig', '系统应用配置', 'http://127.0.0.1:9216', 'text', 'MGR', '0', 0, NOW());

INSERT INTO `t_sys_config` (`config_key`, `config_name`, `config_desc`, `group_key`, `group_name`, `config_val`, `type`, `sys_type`, `belong_info_id`, `sort_num`, `updated_at`) 
VALUES ('ossUseType', '文件上传服务类型', '文件上传服务类型', 'ossConfig', '文件上传服务', 'localFile', 'radio', 'MGR', '0', 0, NOW());
INSERT INTO `t_sys_config` (`config_key`, `config_name`, `config_desc`, `group_key`, `group_name`, `config_val`, `type`, `sys_type`, `belong_info_id`, `sort_num`, `updated_at`) 
...
INSERT INTO `t_sys_config` (`config_key`, `config_name`, `config_desc`, `group_key`, `group_name`, `config_val`, `type`, `sys_type`, `belong_info_id`, `sort_num`, `updated_at`) 
VALUES ('passwordRegexp', '密码规则', '密码规则(正则表达式)', 'securityConfig', '安全配置', '{"regexpRules":"^.{6,}$","errTips":"密码不符合规则，最少6位"}', 'text', 'MGR', '0', 0, NOW());
...
-- 初始化商户系统系统参数
INSERT INTO `t_sys_config` (`config_key`, `config_name`, `config_desc`, `group_key`, `group_name`, `config_val`, `type`, `sys_type`, `belong_info_id`, `sort_num`, `updated_at`) 
VALUES ('appVoice', '是否启用app订单语音播报', '是否启用app订单语音播报', 'orderConfig', '系统配置', '1', 'radio', 'MCH', 'M0000000000', 0, NOW());
INSERT INTO `t_sys_config` (`config_key`, `config_name`, `config_desc`, `group_key`, `group_name`, `config_val`, `type`, `sys_type`, `belong_info_id`, `sort_num`, `updated_at`) 
VALUES ('qrcEscaping', '是否启用码牌防逃单功能', '是否启用码牌防逃单功能', 'orderConfig', '系统配置', '1', 'radio', 'MCH', 'M0000000000', 0, NOW());

INSERT INTO `t_sys_config` (`config_key`, `config_name`, `config_desc`, `group_key`, `group_name`, `config_val`, `type`, `sys_type`, `belong_info_id`, `sort_num`, `updated_at`) 
VALUES ('mchPayNotifyUrl', 'POS支付回调地址', 'POS支付回调地址', 'payOrderNotifyConfig', '回调和查单参数', '', 'text', 'MCH', 'M0000000000', 10, NOW());
INSERT INTO `t_sys_config` (`config_key`, `config_name`, `config_desc`, `group_key`, `group_name`, `config_val`, `type`, `sys_type`, `belong_info_id`, `sort_num`, `updated_at`) 
VALUES ('mchRefundNotifyUrl', 'POS退款回调地址', 'POS退款回调地址', 'payOrderNotifyConfig', '回调和查单参数', '', 'text', 'MCH', 'M0000000000', 20, NOW());
INSERT INTO `t_sys_config` (`config_key`, `config_name`, `config_desc`, `group_key`, `group_name`, `config_val`, `type`, `sys_type`, `belong_info_id`, `sort_num`, `updated_at`) 
VALUES ('mchNotifyPostType', '商户接收通知方式', '商户接收通知方式', 'payOrderNotifyConfig', '回调和查单参数', 'POST_JSON', 'radio', 'MCH', 'M0000000000', 30, NOW());
INSERT INTO `t_sys_config` (`config_key`, `config_name`, `config_desc`, `group_key`, `group_name`, `config_val`, `type`, `sys_type`, `belong_info_id`, `sort_num`, `updated_at`) 
VALUES ('payOrderNotifyExtParams', '支付订单回调和查单参数', '支付订单回调和查单参数', 'payOrderNotifyConfig', '回调和查单参数', '[]', 'text', 'MCH', 'M0000000000', 40, NOW());

INSERT INTO `t_sys_config` (`config_key`, `config_name`, `config_desc`, `group_key`, `group_name`, `config_val`, `type`, `sys_type`, `belong_info_id`, `sort_num`, `updated_at`) 
VALUES ('divisionConfig', '分账管理', '分账管理', 'divisionManage', '分账管理', '{"overrideAutoFlag":0,"autoDivisionRules":{"amountLimit":0,"delayTime":120},"mchDivisionEntFlag":1}', 'text', 'MCH', 'M0000000000', 0, NOW());

INSERT INTO `t_sys_config` (`config_key`, `config_name`, `config_desc`, `group_key`, `group_name`, `config_val`, `type`, `sys_type`, `belong_info_id`, `sort_num`, `updated_at`) 
VALUES ('mchApiEntList', '商户接口权限集合', '商户接口权限集合', 'mchApiEnt', '商户接口权限集合', '[]', 'text', 'MCH', 'M0000000000', 0, NOW());

-- 会员配置
INSERT INTO `t_sys_config` (`config_key`, `config_name`, `config_desc`, `group_key`, `group_name`, `config_val`, `type`, `sys_type`, `belong_info_id`, `sort_num`, `updated_at`) 
VALUES ('mbrMaxBalance', '会员最大储值余额(元), 0表示依据系统配置', '会员最大储值余额(元), 0表示依据系统配置', 'mbrConfig', '会员配置', '1', 'text', 'MCH', 'M0000000000', 0, NOW());
INSERT INTO `t_sys_config` (`config_key`, `config_name`, `config_desc`, `group_key`, `group_name`, `config_val`, `type`, `sys_type`, `belong_info_id`, `sort_num`, `updated_at`) 
VALUES ('mbrCustomAmountState', '充值自定义金额', '充值自定义金额', 'mbrConfig', '会员配置', '1', 'radio', 'MCH', 'M0000000000', 0, NOW());
INSERT INTO `t_sys_config` (`config_key`, `config_name`, `config_desc`, `group_key`, `group_name`, `config_val`, `type`, `sys_type`, `belong_info_id`, `sort_num`, `updated_at`) 
VALUES ('mbrModelState', '会员模块状态开关', '会员模块状态开关', 'mbrConfig', '会员配置', '1', 'radio', 'MCH', 'M0000000000', 0, NOW());
INSERT INTO `t_sys_config` (`config_key`, `config_name`, `config_desc`, `group_key`, `group_name`, `config_val`, `type`, `sys_type`, `belong_info_id`, `sort_num`, `updated_at`) 
VALUES ('mbrPayState', '会员支付开关', '会员支付开关', 'mbrConfig', '会员配置', '1', 'radio', 'MCH', 'M0000000000', 0, NOW());
