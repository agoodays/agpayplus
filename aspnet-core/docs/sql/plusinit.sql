...
INSERT INTO `t_sys_config` VALUES ('apiMapWebKey', '[高德地图商户端web配置]Key', '高德地图Key', 'apiMapConfig', '高德地图商户端web配置', 'af5a39c9bc57d1ba6cebe65ba50a4c8b', 'text', 0, '2023-02-11 18:30:00');
INSERT INTO `t_sys_config` VALUES ('apiMapWebSecret', '[高德地图商户端web配置]秘钥', '高德地图Key', 'apiMapConfig', '高德地图商户端web配置', 'dccbb518e65a7f86d2af50eda2b62f13', 'text', 0, '2023-02-11 18:30:00');
INSERT INTO `t_sys_config` VALUES ('apiMapWebServiceKey', '[高德地图商户端web服务]Key', '商户端web服务key', 'apiMapConfig', '高德地图商户端web配置', 'b2a0b3a8fcd2d73c1ce71e558c3d4c16', 'text', 0, '2023-02-11 18:30:00');
INSERT INTO `t_sys_config` VALUES ('ossUseType', '文件上传服务类型', '文件上传服务类型', 'ossConfig', '文件上传服务', 'localFile', 'radio', 0, '2023-02-11 18:30:00');
INSERT INTO `t_sys_config` VALUES ('aliyunOssConfig', '阿里云oss配置', '阿里云oss配置', 'ossConfig', '阿里云oss配置', '{"accessKeyId":"MVqr64GEqjdI6y7xTMVqry7xLTAjsTo1","endpoint":"oss-cn-beijing.aliyuncs.com","expireTime":30000,"publicBucketName":"agpaypublic","privateBucketName":"agpayprivate","accessKeySecret":"q91sDeWVv8GhuoUY95a6x7NAlsMIYo"}', 'text', 0, '2023-02-11 18:30:00');
...
INSERT INTO `t_sys_config` VALUES ('smsProviderKey', '短信使用厂商', '短信使用厂商', 'smsConfig', '短信配置', 'agpaydx', 'radio', 'MGR', '0', 0, '2023-11-11 18:30:00');
INSERT INTO `t_sys_config` VALUES ('agpaydxSmsConfig', '[吉日短信]短信配置', '[吉日短信]短信配置', 'smsConfig', '短信配置', '{"signName":"吉日付","userName":"agooday","accountPwd":"agooday"}', 'text', 'MGR', '0', 0, '2023-11-11 18:30:00');
INSERT INTO `t_sys_config` VALUES ('aliyundySmsConfig', '阿里云短信服务', '阿里云短信服务', 'smsConfig', '短信配置', '{"accessKeyId":"DqogEAI5tChnz8Syhgm5FLTZ","loginMchTemplateId":"SMS_178515044","registerMchTemplateId":"SMS_215795545","accessKeySecret":"boNe3GlkGe9l7q9aoApu17oHlUV7Ge","signName":"吉日科技","mbrTelBindTemplateId":"SMS_215790589","forgetPwdTemplateId":"SMS_215795546","accountOpenTemplateId":"SMS_234420379"}', 'text', 'MGR', '0', 0, '2023-11-11 18:30:00');
INSERT INTO `t_sys_config` VALUES ('mocktestSmsConfig', '[模拟测试]短信配置', '[模拟测试]短信配置', 'smsConfig', '短信配置', '{"mockCode": "888666"}', 'text', 'MGR', '0', 0, '2023-11-11 18:30:00');

INSERT INTO `t_sys_config` VALUES ('ocrType', 'OCR识别使用类型', 'OCR识别使用类型 1-腾讯OCR 2-阿里OCR', 'ocrConfig', 'OCR识别参数配置', '1', 'radio', 'MGR', '0', 0, '2023-11-11 18:30:00');
INSERT INTO `t_sys_config` VALUES ('ocrState', 'OCR识别使用状态', 'OCR识别使用状态 0-关闭 1-开启', 'ocrConfig', 'OCR识别参数配置', '1', 'radio', 'MGR', '0', 0, '2023-11-11 18:30:00');
INSERT INTO `t_sys_config` VALUES ('tencentOcrConfig', '腾讯OCR识别参数配置', '腾讯OCR识别参数配置', 'ocrConfig', 'OCR识别参数配置', '{"secretId":"HK7ewxhiuqVsCUVFAKBOKzNTJr88svhIDyoN","secretKey":"Q9blfIejY6qnTs1tNJL7cM5XUord9Qje"}', 'text', 'MGR', '0', 0, '2023-11-11 18:30:00');
INSERT INTO `t_sys_config` VALUES ('aliOcrConfig', '阿里OCR识别参数配置', '阿里OCR识别参数配置', 'ocrConfig', 'OCR识别参数配置', '{"accessKeyId": "MVqr64GEqjdI6y7xTMVqry7xLTAjsTo1","accessKeySecret": "q91sDeWVv8GhuoUY95a6x7NAlsMIYo"}', 'text', 'MGR', '0', 0, '2023-11-11 18:30:00');
...
INSERT INTO t_sys_entitlement VALUES('ENT_ORDER_STATISTIC', '数据统计', 'bar-chart', '', 'RouteView', 'ML', 0, 1,  'ROOT', '53', 'MGR', NOW(), NOW());
    ...
    INSERT INTO t_sys_entitlement VALUES('ENT_STATISTIC_MCH_STORE', '门店统计', 'no-icon', '', '', 'PB', 0, 1,  'ENT_STATISTIC_MCH', '10', 'MGR', NOW(), NOW());
    INSERT INTO t_sys_entitlement VALUES('ENT_STATISTIC_MCH_WAY_CODE', '支付方式统计', 'no-icon', '', '', 'PB', 0, 1,  'ENT_STATISTIC_MCH', '20', 'MGR', NOW(), NOW());
...
ALTER TABLE `t_pay_order`   
  ...
  ADD COLUMN `seller_remark` VARCHAR(256) NULL COMMENT '卖家备注' AFTER `body`,
  ADD COLUMN `buyer_remark` VARCHAR(256) NULL COMMENT '买家备注' AFTER `seller_remark`,
...
INSERT INTO t_sys_entitlement VALUES ('ENT_AGENT', '代理商管理', 'shop', '', 'RouteView', 'ML', 0, 1,  'ROOT', '35', 'MGR', NOW(), NOW());
    INSERT INTO t_sys_entitlement VALUES ('ENT_AGENT_INFO', '代理商列表', 'profile', '/agent', 'AgentPage', 'ML', 0, 1, 'ENT_AGENT', '10', 'MGR', NOW(), NOW());
...
INSERT INTO t_sys_entitlement VALUES ('ENT_MCH', '商户管理', 'shop', '', 'RouteView', 'ML', 0, 1, 'ROOT', 30, 'AGENT', NOW(), NOW());
    INSERT INTO t_sys_entitlement VALUES ('ENT_MCH_INFO', '商户列表', 'profile', '/mch', 'MchPage', 'ML', 0, 1, 'ENT_MCH', 10, 'AGENT', NOW(), NOW());
...
INSERT INTO t_sys_entitlement VALUES ('ENT_AGENT', '代理商管理', 'shop', '', 'RouteView', 'ML', 0, 1, 'ROOT', 35, 'AGENT', NOW(), NOW());
    INSERT INTO t_sys_entitlement VALUES ('ENT_AGENT_INFO', '代理商列表', 'profile', '/agent', 'AgentPage', 'ML', 0, 1, 'ENT_AGENT', 10, 'AGENT', NOW(), NOW());
...
--    INSERT INTO t_sys_entitlement VALUES ('ENT_ISV_INFO', '服务商列表', 'profile', '/isv', 'IsvPage', 'ML', 0, 1, 'ENT_ISV', 10, 'AGENT', NOW(), NOW());
...
INSERT INTO t_sys_entitlement VALUES ('ENT_ORDER', '订单管理', 'transaction', '', 'RouteView', 'ML', 0, 1, 'ROOT', 50, 'AGENT', NOW(), NOW());
    INSERT INTO t_sys_entitlement VALUES ('ENT_PAY_ORDER', '支付订单', 'account-book', '/pay', 'PayOrderPage', 'ML', 0, 1, 'ENT_ORDER', 10, 'AGENT', NOW(), NOW());
    ...
    INSERT INTO t_sys_entitlement VALUES ('ENT_REFUND_ORDER', '退款订单', 'exception', '/refund', 'RefundOrderPage', 'ML', 0, 1, 'ENT_ORDER', 20, 'AGENT', NOW(), NOW());
...
--    INSERT INTO t_sys_entitlement VALUES ('ENT_TRANSFER_ORDER', '转账订单', 'property-safety', '/transfer', 'TransferOrderPage', 'ML', 0, 1, 'ENT_ORDER', 25, 'AGENT', NOW(), NOW());
...
--    INSERT INTO t_sys_entitlement VALUES ('ENT_MCH_NOTIFY', '商户通知', 'notification', '/notify', 'MchNotifyPage', 'ML', 0, 1, 'ENT_ORDER', 30, 'AGENT', NOW(), NOW());
...
CREATE TABLE `t_mch_apply` (
  ...
  `channel_ext_params` JSON NULL COMMENT '渠道扩展参数(JSON, 替代原 channel_var1/2)',
...
ALTER TABLE `t_sys_entitlement`   
  ADD COLUMN `match_rule` JSON NULL COMMENT '权限匹配规则' AFTER `quick_jump`;
