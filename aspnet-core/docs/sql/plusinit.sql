...
CREATE TABLE `t_agent_info` (
  ...
  `agent_type` TINYINT NOT NULL DEFAULT '1' COMMENT '类型: 1-普通代理商, 2-特约代理商(服务商模式)',
...
--   `login_user_name` VARCHAR(32) COMMENT '登录名', 
  `init_user_id` VARCHAR(128) NOT NULL COMMENT '登录名', 
  ...
  `un_amount` INT NOT NULL DEFAULT '0' COMMENT '钱包余额', 
