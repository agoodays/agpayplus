...
INSERT INTO `t_sys_config` VALUES ('smsProviderKey', '短信使用厂商', '短信使用厂商', 'smsConfig', '短信配置', 'agpaydx', 'radio', 0, '2023-11-11 18:30:00');
INSERT INTO `t_sys_config` VALUES ('agpaydxSmsConfig', '[吉日短信]短信配置', '[吉日短信]短信配置', 'smsConfig', '短信配置', '{"signName":"吉日付","userName":"agooday","accountPwd":"agooday"}', 'text', 0, '2023-11-11 18:30:00');
INSERT INTO `t_sys_config` VALUES ('aliyundySmsConfig', '阿里云短信服务', '阿里云短信服务', 'smsConfig', '短信配置', '{"accessKeyId":"LTAI5tChn8DqogEzgm5FSyhZ","loginMchTemplateId":"SMS_178515044","registerMchTemplateId":"SMS_215795545","accessKeySecret":"u17oH643fd9bee4b0tChn8Dqogea5ec3aoApV","signName":"吉日科技","mbrTelBindTemplateId":"SMS_215790589","forgetPwdTemplateId":"SMS_215795546","accountOpenTemplateId":"SMS_234420379"}', 'text', 0, '2023-11-11 18:30:00');
INSERT INTO `t_sys_config` VALUES ('mocktestSmsConfig', '[模拟测试]短信配置', '[模拟测试]短信配置', 'smsConfig', '短信配置', '{"mockCode": "888666"}', 'text', 0, '2023-11-11 18:30:00');

INSERT INTO `t_sys_config` VALUES ('ocrType', 'OCR识别使用类型', 'OCR识别使用类型 1-腾讯OCR 2-阿里OCR', 'ocrConfig', 'OCR识别参数配置', '1', 'radio', 0, '2023-11-11 18:30:00');
INSERT INTO `t_sys_config` VALUES ('ocrState', 'OCR识别使用状态', 'OCR识别使用状态 0-关闭 1-开启', 'ocrConfig', 'OCR识别参数配置', '1', 'radio', 0, '2023-11-11 18:30:00');
INSERT INTO `t_sys_config` VALUES ('tencentOcrConfig', '腾讯OCR识别参数配置', '腾讯OCR识别参数配置', 'ocrConfig', 'OCR识别参数配置', '{"secretId":"AKIDHK7ewxhBOKzNTJr88svhCUVFiuqVsyoN","secretKey":"JL7cqLTAI5tChn8DqogEzgm5FSyhZQQ9blje"}', 'text', 0, '2023-11-11 18:30:00');
INSERT INTO `t_sys_config` VALUES ('aliOcrConfig', '阿里OCR识别参数配置', '阿里OCR识别参数配置', 'ocrConfig', 'OCR识别参数配置', '{"accessKeyId": "LTAI4GEqjdMVqr6y7xTjsTo1","accessKeySecret": "lsMY9TAI5tChn8DqogEzgm5FSyhq91sDTAI5tC"}', 'text', 0, '2023-11-11 18:30:00');
