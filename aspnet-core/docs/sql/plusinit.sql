...
INSERT INTO `t_sys_config` VALUES ('tencentOcrConfig', '腾讯OCR识别参数配置', '腾讯OCR识别参数配置', 'ocrConfig', 'OCR识别参数配置', '{"secretId":"AKIDHK7ewxhBOKzNTJr88svhCUVFiuqVsyoN","secretKey":"JL7cqLTAI5tChn8DqogEzgm5FSyhZQQ9blje"}', 'text', 'MGR', '0', 0, '2023-11-11 18:30:00');
INSERT INTO `t_sys_config` VALUES ('aliOcrConfig', '阿里OCR识别参数配置', '阿里OCR识别参数配置', 'ocrConfig', 'OCR识别参数配置', '{"accessKeyId": "LTAI4GEqjdMVqr6y7xTjsTo1","accessKeySecret": "lsMY9TAI5tChn8DqogEzgm5FSyhq91sDTAI5tC"}', 'text', 'MGR', '0', 0, '2023-11-11 18:30:00');
