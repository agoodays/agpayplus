...
namespace AGooday.AgPay.Components.MQ.Models
{
    ...
    /// 业务场景： [ 清除商户登录信息 ]
    /// </summary>
    public class CleanAgentLoginAuthCacheMQ : AbstractMQ
    {
        /// <summary>
        /// 【！重要配置项！】 定义MQ名称
        /// </summary>
        public static readonly string MQ_NAME = "QUEUE_CLEAN_AGENT_LOGIN_AUTH_CACHE";
        ...
        public CleanAgentLoginAuthCacheMQ(MsgPayload payload) => Payload = payload;
        ...
        /// <returns></returns>
        public static CleanAgentLoginAuthCacheMQ Build(List<long> userIdList) => new CleanAgentLoginAuthCacheMQ(new MsgPayload(userIdList));
