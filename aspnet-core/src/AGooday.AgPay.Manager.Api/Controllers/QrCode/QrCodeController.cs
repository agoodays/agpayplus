...
namespace AGooday.AgPay.Manager.Api.Controllers.QrCode
{
    ...
    {
        public static Bitmap GenerateStyleAImage(int width = 1190, int height = 1684, string backgroundColor = "#ff0000", int cornerRadius = 50, string logoPath = null, string title = null, string content = "https://www.example.com", Bitmap icon = null, string text = "No.220101000001", List<PayType> payTypes = null)
        {
            int leftMargin = (int)(width * 0.1);
            int topMargin = (int)(width * 0.3);
            int bottomMargin = (int)(width * 0.1);
        ...
        public static Bitmap GenerateStyleBImage(int width = 1190, int height = 1684, string backgroundColor = "#ff0000", int cornerRadius = 50, string logoPath = null, string title = null, string content = "https://www.example.com", Bitmap icon = null, string text = "No.220101000001", List<PayType> payTypes = null)
        {
            int leftMargin = (int)(width * 0.1);
