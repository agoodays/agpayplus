...
namespace AGooday.AgPay.Agent.Api.Controllers.PayConfig
{
    ...
    public class PayWayController : ControllerBase
    {
        ...
        /// <returns></returns>
        [HttpGet, Route(""), NoLog]
        [PermissionAuth(PermCode.AGENT.ENT_PC_WAY_LIST, PermCode.AGENT.ENT_PAY_ORDER_SEARCH_PAY_WAY)]
        ...
        [PermissionAuth(PermCode.AGENT.ENT_PC_WAY_ADD)]
        ...
        [PermissionAuth(PermCode.AGENT.ENT_PC_WAY_DEL)]
        ...
        [PermissionAuth(PermCode.AGENT.ENT_PC_WAY_EDIT)]
        ...
        [PermissionAuth(PermCode.AGENT.ENT_PC_WAY_VIEW, PermCode.AGENT.ENT_PC_WAY_EDIT)]
