...
namespace AGooday.AgPay.Agent.Api.Controllers.Isv
{
    ...
    public class IsvPayInterfaceConfigController : CommonController
    {
        ...
        /// <returns></returns>
        [HttpGet, Route(""), NoLog]
        [PermissionAuth(PermCode.AGENT.ENT_ISV_PAY_CONFIG_LIST)]
        ...
        [PermissionAuth(PermCode.AGENT.ENT_ISV_PAY_CONFIG_VIEW)]
        ...
        [PermissionAuth(PermCode.AGENT.ENT_ISV_PAY_CONFIG_ADD)]
