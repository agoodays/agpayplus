...
namespace AGooday.AgPay.Agent.Api.Controllers.Isv
{
    /// <summary>
    /// 服务商管理类
    /// </summary>
    ...
    public class IsvInfoController : CommonController
    {
        ...
        /// <returns></returns>
        [HttpGet, Route(""), NoLog]
        [PermissionAuth(PermCode.AGENT.ENT_ISV_LIST)]
        ...
        [PermissionAuth(PermCode.AGENT.ENT_ISV_INFO_ADD)]
        ...
        [PermissionAuth(PermCode.AGENT.ENT_ISV_INFO_DEL)]
        ...
        [PermissionAuth(PermCode.AGENT.ENT_ISV_INFO_EDIT)]
        ...
        [PermissionAuth(PermCode.AGENT.ENT_ISV_INFO_VIEW, PermCode.AGENT.ENT_ISV_INFO_EDIT)]
