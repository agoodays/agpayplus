...
namespace AGooday.AgPay.Payment.Api.Jobs
{
    ...
    public class TransferOrderReissueJob : AbstractJob
    {
        ...
        private readonly TransferOrderReissueService _transferOrderReissueService;

        public TransferOrderReissueJob(
            ILogger<TransferOrderReissueJob> logger,
            ...
            : base(logger, cacheService)
        {
            ...
            _transferOrderReissueService = transferOrderReissueService;
        }
            ...
            await ExecuteLockTakeAsync(context.JobDetail.Key.ToString(), async () =>
            {
                ...
                while (true)
                {
                    try
                    {
                        ...
                        {
                            await _transferOrderReissueService.ProcessOrderAsync(transferOrder);
                        }
