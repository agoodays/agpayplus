...
namespace AGooday.AgPay.Payment.Api.RQRS.PayOrder
{
    public class UnifiedOrderRQ : AbstractMchAppRQ
    {
        ...
        public string wayCode { get; protected set; }
        ...
        /// 异步通知地址
        /// </summary>
        public string notifyUrl { get; protected set; }
        ...
        /// 订单失效时间, 单位：秒
        /// </summary>
        public int expiredTime { get; protected set; }

        /// <summary>
        /// 特定渠道发起额外参数
        /// </summary>
        public string channelExtra { get; protected set; }

        /// <summary>
        /// 商户扩展参数
        /// </summary>
        public string extParam { get; protected set; }

        /// <summary>
        /// 分账模式： 0-该笔订单不允许分账, 1-支付成功按配置自动完成分账, 2-商户手动分账(解冻商户金额) 
        /// </summary>
        [Range(0, 2, ErrorMessage = "分账模式设置值有误")]
        public byte divisionMode { get; protected set; }
