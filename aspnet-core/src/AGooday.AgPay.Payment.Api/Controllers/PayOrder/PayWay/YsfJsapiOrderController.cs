...
namespace AGooday.AgPay.Payment.Api.Controllers.PayOrder.PayWay
{
    ...
    {
        public YsfJsapiOrderController(Func<string, IPaymentService> paymentServiceFactory,
        ...
        /// </summary>
        [HttpPost]
        [Route("api/pay/ysfJsapiOrder")]
        public ActionResult<ApiRes> YsfJsapiOrder(AliJsapiOrderRQ bizRQ)
        {
            // 统一下单接口
