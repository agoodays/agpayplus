namespace AGooday.AgPay.Application.Params.AliPay
{
    ...
    public class AliPayConfig
    {
        ...
        public const string SANDBOX_OAUTH_URL = "https://openapi-sandbox.dl.alipaydev.com/oauth2/publicAppAuthorize.htm?app_id={0}&scope=auth_base&state=&redirect_uri={1}";
        ...
        public const string SANDBOX_APP_TO_APP_AUTH_URL = "https://openapi-sandbox.dl.alipaydev.com/oauth2/appToAppAuth.htm?app_id={0}&redirect_uri={1}&state={2}";
