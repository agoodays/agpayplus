...
{
    public class UmsPayApplymentChannelNoticeService : AbstractApplymentChannelNoticeService
    {
        public UmsPayApplymentChannelNoticeService(
            ILogger<UmsPayApplymentChannelNoticeService> logger,
        ...
        public UmsPayApplymentChannelNoticeService() : base() { }
