...
{
    public class SxfPayApplymentChannelNoticeService : AbstractApplymentChannelNoticeService
    {
        public SxfPayApplymentChannelNoticeService(
            ILogger<SxfPayApplymentChannelNoticeService> logger,
        ...
        public SxfPayApplymentChannelNoticeService() : base() { }
