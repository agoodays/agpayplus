...
{
    public class DgPayApplymentChannelNoticeService : AbstractApplymentChannelNoticeService
    {
        public DgPayApplymentChannelNoticeService(
            ILogger<DgPayApplymentChannelNoticeService> logger,
        ...
        public DgPayApplymentChannelNoticeService() : base() { }
