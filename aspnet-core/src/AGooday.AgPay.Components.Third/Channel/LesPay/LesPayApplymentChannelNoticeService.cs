...
{
    public class LesPayApplymentChannelNoticeService : AbstractApplymentChannelNoticeService
    {
        public LesPayApplymentChannelNoticeService(
            ILogger<LesPayApplymentChannelNoticeService> logger,
        ...
        public LesPayApplymentChannelNoticeService() : base() { }
