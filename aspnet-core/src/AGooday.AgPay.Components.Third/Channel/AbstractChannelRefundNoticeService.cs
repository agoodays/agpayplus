...
namespace AGooday.AgPay.Components.Third.Channel
{
    public abstract class AbstractChannelRefundNoticeService : IChannelRefundNoticeService
    {
        ...
        protected AbstractChannelRefundNoticeService()
        {
        }
        ...
        public abstract Task<ChannelRetMsg> DoNoticeAsync(HttpRequest request, object @params, RefundOrderDto payOrder, MchAppConfigContext mchAppConfigContext, NoticeTypeEnum noticeTypeEnum);
