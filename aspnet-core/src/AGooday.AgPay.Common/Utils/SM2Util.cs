...
namespace AGooday.AgPay.Common.Utils
{
    public class SM2Util
    {
        ...
        public static string SignWithSM3(string privateKeyPem, string messageData, bool asn1Encoding = true)
        {
            ...
            byte[] signBytes = SignWithSM3(
                ...
                messageBytes: Encoding.UTF8.GetBytes(messageData),
                asn1Encoding: asn1Encoding
            );
        ...
        /// <param name="asn1Encoding">指示签名结果是否为 ASN.1 编码的形式。（默认值：true）</param>
        /// <returns>签名字节数组。</returns>
        public static byte[] SignWithSM3ByECPrivateKey(string encodingECPrivateKey, byte[] uidBytes, byte[] messageBytes, bool asn1Encoding = true)
        {
            if (encodingECPrivateKey is null) throw new ArgumentNullException(nameof(encodingECPrivateKey));
            if (uidBytes is null) throw new ArgumentNullException(nameof(uidBytes));
            if (messageBytes is null) throw new ArgumentNullException(nameof(messageBytes));

            return SignWithSM3ByECPrivateKey(
                ecPrivateKeyBytes: FromHexString(encodingECPrivateKey),
                uidBytes: uidBytes,
                messageBytes: messageBytes,
                asn1Encoding: asn1Encoding
            );
        ...
        /// <param name="asn1Encoding">指示签名结果是否为 ASN.1 编码的形式。（默认值：true）</param>
        /// <returns>签名字节数组。</returns>
        public static byte[] SignWithSM3ByECPrivateKey(string encodingECPrivateKey, byte[] messageBytes, bool asn1Encoding = true)
        {
            return SignWithSM3ByECPrivateKey(
        ...
        /// <param name="asn1Encoding">指示签名结果是否为 ASN.1 编码的形式。（默认值：true）</param>
        /// <returns>验证结果。</returns>
        public static bool VerifyWithSM3(string publicKeyPem, string messageData, string encodingSignature, bool asn1Encoding = true)
        {
            if (publicKeyPem is null) throw new ArgumentNullException(nameof(publicKeyPem));
            if (messageData is null) throw new ArgumentNullException(nameof(messageData));
            if (encodingSignature is null) throw new ArgumentNullException(nameof(encodingSignature));

            return VerifyWithSM3(
                publicKeyBytes: ConvertPublicKeyPemToByteArray(publicKeyPem),
                messageBytes: Encoding.UTF8.GetBytes(messageData),
                signBytes: Convert.FromBase64String(encodingSignature),
                asn1Encoding: asn1Encoding
            );
        }
        ...
        /// <param name="asn1Encoding">指示签名结果是否为 ASN.1 编码的形式。（默认值：true）</param>
        /// <returns>验证结果。</returns>
        public static bool VerifyWithSM3ByCertificate(string certificatePem, string messageData, string encodingSignature, bool asn1Encoding = true)
        {
        ...
        /// <param name="asn1Encoding">指示签名结果是否为 ASN.1 编码的形式。（默认值：true）</param>
        /// <returns>签名字节数组。</returns>
        public static bool VerifyWithSM3ByECPublicKey(string encodingECPublicKey, byte[] uidBytes, byte[] messageBytes, byte[] signBytes, bool asn1Encoding = true)
        {
            if (encodingECPublicKey is null) throw new ArgumentNullException(nameof(encodingECPublicKey));
            if (uidBytes is null) throw new ArgumentNullException(nameof(uidBytes));
            if (messageBytes is null) throw new ArgumentNullException(nameof(messageBytes));

            return VerifyWithSM3ByECPublicKey(
                ecPublicKeyBytes: FromHexString(encodingECPublicKey),
                uidBytes: uidBytes,
                messageBytes: messageBytes,
                signBytes: signBytes,
                asn1Encoding: asn1Encoding
        ...
        /// <param name="asn1Encoding">指示签名结果是否为 ASN.1 编码的形式。（默认值：true）</param>
        /// <returns>签名字节数组。</returns>
        public static bool VerifyWithSM3ByECPublicKey(string encodingECPublicKey, byte[] messageBytes, byte[] signBytes, bool asn1Encoding = true)
        {
            return VerifyWithSM3ByECPublicKey(
        ...
        public static string Decrypt(string privateKeyPem, string encodingCipher, bool asn1Encoding = true)
        {
            if (privateKeyPem is null) throw new ArgumentNullException(nameof(privateKeyPem));
            if (encodingCipher is null) throw new ArgumentNullException(nameof(encodingCipher));

            byte[] plainBytes = Decrypt(
                privateKeyBytes: ConvertPrivateKeyPemToByteArray(privateKeyPem),
                cipherBytes: Convert.FromBase64String(encodingCipher),
                asn1Encoding: asn1Encoding
            );
            return Convert.ToBase64String(plainBytes);//Encoding.UTF8.GetString(plainBytes);
        }
        ...
        /// <param name="asn1Encoding">指示加密结果是否为 ASN.1 编码的形式。（默认值：true）</param>
        /// <returns>解密后的数据。</returns>
        public static byte[] DecryptByECPrivateKey(string encodingECPrivateKey, byte[] cipherBytes, bool asn1Encoding = true)
        {
            if (encodingECPrivateKey is null) throw new ArgumentNullException(nameof(encodingECPrivateKey));
        ...
        public static string Encrypt(string publicKeyPem, string plainData, bool asn1Encoding = true)
        {
            if (publicKeyPem is null) throw new ArgumentNullException(nameof(publicKeyPem));
            ...
            byte[] cipherBytes = Encrypt(
                publicKeyBytes: ConvertPublicKeyPemToByteArray(publicKeyPem),
                plainBytes: Convert.FromBase64String(plainData),//Encoding.UTF8.GetBytes(plainData),
                asn1Encoding: asn1Encoding
            );
        ...
        /// <param name="asn1Encoding">指示加密结果是否为 ASN.1 编码的形式。（默认值：true）</param>
        /// <returns>经过 Base64 编码的加密数据。</returns>
        public static string EncryptByCertificate(string certificatePem, string plainData, bool asn1Encoding = true)
        {
            if (certificatePem is null) throw new ArgumentNullException(nameof(certificatePem));
        ...
        /// <param name="asn1Encoding">指示加密结果是否为 ASN.1 编码的形式。（默认值：true）</param>
        /// <returns>加密后的数据字节数组。</returns>
        public static byte[] EncryptByECPublicKey(string encodingECPublicKey, byte[] plainBytes, bool asn1Encoding = true)
        {
            if (encodingECPublicKey is null) throw new ArgumentNullException(nameof(encodingECPublicKey));
