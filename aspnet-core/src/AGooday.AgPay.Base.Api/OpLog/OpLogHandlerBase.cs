...
namespace AGooday.AgPay.Base.Api.OpLog
{
    /// <summary>
    /// 操作日志处理基类
    /// </summary>
    public abstract class OpLogHandlerBase : IOpLogHandler
    {
        private readonly ILogger _logger;
        private readonly ISysLogService _sysLogService;
        private static IHttpContextAccessor _context;

        protected OpLogHandlerBase(ILogger logger, IHttpContextAccessor httpContextAccessor, ISysLogService sysLogService)
        {
            _logger = logger;
