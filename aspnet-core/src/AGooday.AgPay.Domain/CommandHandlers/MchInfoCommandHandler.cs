        ...
        IRequestHandler<RemoveMchInfoCommand>
    {
        ...
        public async Task Handle(ModifyMchInfoCommand request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                {
                    if (await _sysUserRepository.IsExistTelphoneAsync(request.ContactTel, CS.SYS_TYPE.MCH))
                    {
                ...
                {
                    await _mqSender.SendAsync(CleanLoginAuthCacheMQ.Build(CS.SYS_TYPE.MCH, removeCacheUserIdList));
                }
        ...
        public async Task Handle(RemoveMchInfoCommand request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                await _mqSender.SendAsync(CleanLoginAuthCacheMQ.Build(CS.SYS_TYPE.MCH, userIdList));
