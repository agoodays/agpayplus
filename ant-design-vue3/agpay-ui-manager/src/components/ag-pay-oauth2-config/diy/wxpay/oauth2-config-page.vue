    ...
    <a-row :gutter="24">
      ...
      <a-col span="12">
        <a-form-model-item label="服务商的小程序appSecret" prop="liteAppSecret">
          <a-input
            v-model="ifParams.liteAppSecret"
...
export default {
  ...
  data() {
    ...
    this.formData.liteAppSecret_ph = this.formData.liteAppSecret
