        ...
        <a-collapse-panel key="1" :header="configMode === 'mgrIsv' ? '服务商三方应用参数配置' : '商户应用参数配置'">
          ...
          <a-col span="24">
            <a-form-model-item label="支付宝公钥" prop="alipayPublicKey">
              <a-input
                v-model="ifParams.alipayPublicKey"
                type="textarea"
        ...
        <a-collapse-panel key="2">
          ...
          <a-col span="24">
            <a-form-model-item label="环境配置" prop="liteParams.sandbox">
              <a-radio-group
                v-model="ifParams.liteParams.sandbox"
          ...
          <a-col span="12">
            <a-form-model-item label="小程序页面路径" prop="liteParams.pagePath">
              <a-input
                v-model="ifParams.liteParams.pagePath"
                placeholder="请输入PID"
          ...
          <a-col span="12">
            <a-form-model-item label="合作伙伴身份（PID）" prop="liteParams.pid">
              <a-input
                v-model="ifParams.liteParams.pid"
                placeholder="请输入PID"
          ...
          <a-col span="12">
            <a-form-model-item label="应用AppID" prop="liteParams.appId">
              <a-input
                v-model="ifParams.liteParams.appId"
                placeholder="请输入AppID"
          ...
          <a-col span="24">
            <a-form-model-item label="应用私钥" prop="liteParams.privateKey">
              <a-input
                v-model="ifParams.liteParams.privateKey"
                type="textarea"
          ...
          <a-col span="24">
            <a-form-model-item label="支付宝公钥" prop="liteParams.alipayPublicKey">
              <a-input
                v-model="ifParams.liteParams.alipayPublicKey"
                type="textarea"
          ...
          <a-col span="24">
            <a-form-model-item label="接口签名方式(推荐使用RSA2)" prop="liteParams.signType">
              <a-radio-group
                v-model="ifParams.liteParams.signType"
          ...
          <a-col span="24">
            <a-form-model-item label="公钥证书" prop="liteParams.useCert">
              <a-radio-group
                v-model="ifParams.liteParams.useCert"
...
export default {
  ...
  data() {
    ...
    this.formData.alipayPublicKey_ph = this.formData.alipayPublicKey
    ...
    this.formData.liteParams.privateKey_ph = this.formData.liteParams.privateKey
      ? this.formData.liteParams.privateKey
      : '请输入应用私钥'
    if (this.formData.liteParams.privateKey) {
      this.formData.liteParams.privateKey = ''
    }
    this.formData.liteParams.alipayPublicKey_ph = this.formData.liteParams.alipayPublicKey
