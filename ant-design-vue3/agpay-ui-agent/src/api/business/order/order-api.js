...
export const orderApi = {
  ...
  exportPayOrder(params) {
    return req.export(API_URL_PAY_ORDER, 'excel', params)
  },
  exportRefundOrder(params) {
    return req.export(API_URL_REFUND_ORDER, 'excel', params)
  },
  exportTransferOrder(params) {
    return req.export(API_URL_TRANSFER_ORDER, 'excel', params)
  }
}
