    ...
    <a-card :bordered="false">
      ...
      >
        <template #base="{ colSpan }">
          ...
          <a-col v-bind="colSpan">
            <a-form-item label="">
              <ag-input v-model="searchData.storeId" label="门店编号" placeholder="请输入门店编号" allow-clear />
            </a-form-item>
          </a-col>
          <a-col v-bind="colSpan">
            <a-form-item label="">
              <ag-input v-model="searchData.storeName" label="门店名称" placeholder="请输入门店名称" allow-clear />
            </a-form-item>
          </a-col>
        </template>
      </ag-search>
...
const loadDataFunc = async (params) => {
  return await mchStoreApi.queryPage(params)
}
