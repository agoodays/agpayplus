...
export const asyncRouteDefine = {
  ...
  'QrCodeShellPage': { defaultPath: '/shell', component: () => import('@/views/qrCode/shell/CardList') },
  'IfDefinePage': { defaultPath: '/ifdefines', component: () => import('@/views/payconfig/payIfDefine/List') },
  'IsvPage': { defaultPath: '/isv', component: () => import('@/views/isv/IsvPage') }, // 服务商列表
  ...
  'MchNotifyPage': { defaultPath: '/notify', component: () => import('@/views/order/notify/MchNotifyPage') }, // 商户通知列表
