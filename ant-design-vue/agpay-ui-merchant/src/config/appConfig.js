...
export const asyncRouteDefine = {
  ...
  'MchConfigPage': { defaultPath: '/config', component: () => import('@/views/mchConfig/MchConfig') }, // 系统配置

  'MchInfoPage': { defaultPath: '/info', component: () => import ('@/views/mch/MchInfoPage') }, // 商户信息
